...
void main() {
  ...
  final franceNationalExpected = '939876218';
  ...
  final canadaNationalExpected = canadaNational.replaceAll('-', '');
  ...
  final argentinaNationalExpected = argentinaNational.replaceAll(' ', '');
  ...
  final amerSamoaNationalExpected = amerSamoaNational.replaceAll(' ', '');
  ...
  group('PhoneNumber', () {
    group('fromIsoCode', () {
      ...
      test('should create with national prefix', () {
        ...
        expect(francePhone.nsn, equals(franceNationalExpected));
      ...
      test('should create when not main country for iso code', () {
        ...
        expect(canadaPhone.nsn, equals(canadaNationalExpected));
    ...
    group('fromRaw', () {
      ...
      test('should create with international prefix', () {
        ...
        expect(francePhone2.nsn, equals(franceNationalExpected));
