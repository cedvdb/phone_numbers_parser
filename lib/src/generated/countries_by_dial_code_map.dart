      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          mobile: const PhoneValidationRules(
            lengths: [10],
            pattern:
                r"268(?:464|7(?:1[3-9]|[28]\\d|3[0246]|64|7[0-689]))\\d{4}",
          ),
          fixedLine: const PhoneValidationRules(
            lengths: [10],
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          mobile: const PhoneValidationRules(
            lengths: [10],
            pattern:
                r"264(?:235|4(?:69|76)|5(?:3[6-9]|8[1-4])|7(?:29|72))\\d{4}",
          ),
          fixedLine: const PhoneValidationRules(
            lengths: [10],
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          fixedLine: const PhoneValidationRules(
            lengths: [7],
            pattern:
                r"2(?:2[1-7]|3[0-8]|4[12]|5[1256]|6\\d|7[1-3]|8[1-5])\\d{4}",
          ),
        ),
      ),
    ),
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          mobile: const PhoneValidationRules(
            lengths: [9],
            pattern:
                r"(?:6(?:[0-24-8]\\d|3[0-8]|9[589])|7(?:00|[3-9]\\d))\\d{6}",
          ),
          fixedLine: const PhoneValidationRules(
            lengths: [9],
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          fixedLine: const PhoneValidationRules(
            lengths: [8, 9],
            pattern:
                r"1\\d{7}|(?:2[13-5]|3[02367]|4[023]|5[03]|6[026])\\d{6,7}",
          ),
        ),
      ),
    ),
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          general: const PhoneValidationRules(
            lengths: null,
            pattern:
                r"(?:[17]\\d\\d|900)\\d{6}|(?:2|80)0\\d{6,7}|[4-6]\\d{6,8}",
          ),
          mobile: const PhoneValidationRules(
            lengths: [9],
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          mobile: const PhoneValidationRules(
            lengths: [8],
            pattern:
                r"(?:63\\d{3}|73(?:0[0-5]\\d|140))\\d{3}|[67]200[01]\\d{3}",
          ),
          fixedLine: const PhoneValidationRules(
            lengths: [5, 8],
            pattern:
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          fixedLine: const PhoneValidationRules(
            lengths: [8, 10],
            pattern:
                r"(?:(?:195|2)\\d|3[19]|4[159]|5[37]|6[17]|7[39]|85)\\d{6}",
          ),
        ),
      ),
    ),
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          mobile: const PhoneValidationRules(
            lengths: [9],
            pattern:
                r"6[356]9230\\d{3}|(?:6[036]93|9(?:[1-36]\\d\\d|480))\\d{5}",
          ),
          fixedLine: const PhoneValidationRules(
            lengths: [9],
            pattern:
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          mobile: const PhoneValidationRules(
            lengths: [9],
            pattern:
                r"639(?:0[0-79]|1[019]|[267]\\d|3[09]|[45]0|9[04-79])\\d{4}",
          ),
          fixedLine: const PhoneValidationRules(
            lengths: [9],
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          fixedLine: const PhoneValidationRules(
            lengths: [6, 9],
            pattern:
                r"[23][13-6]\\d{7}|(?:2(?:19\\d|[3-6]\\d9)|31\\d\\d)\\d\\d",
          ),
        ),
      ),
    ),
      ...
      phone: const CountryPhoneDescription(
        ...
        validation: const PhoneValidation(
          ...
          mobile: const PhoneValidationRules(
            lengths: [9],
            pattern:
                r"41[18]\\d{6}|(?:[02-4]0|11|5[05]|7[07]|8[08]|9\\d)\\d{7}",
          ),
          fixedLine: const PhoneValidationRules(
            lengths: [9],
            pattern:
