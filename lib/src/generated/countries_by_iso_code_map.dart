...
Map<String, Country> countriesByIsoCode = {
  'AD': const Country(
    name: r'Andorra',
    flag: r'🇦🇩',
    isoCode: r'AD',
    phoneDescription: CountryPhoneDescription(
      dialCode: r'376',
      leadingDigits: null,
      ...
      validation: PhoneValidation(
        ...
        mobile: PhoneValidationRules(
          lengths: [6, 9],
          pattern: r'690\d{6}|[356]\d{5}',
        ),
        fixedLine: PhoneValidationRules(
          lengths: [6],
          pattern: r'[78]\d{5}',
        ),
      ),
  ...
  'MQ': const Country(
    ...
    phoneDescription: CountryPhoneDescription(
      ...
      validation: PhoneValidation(
        ...
        fixedLine: PhoneValidationRules(
          lengths: [9],
          pattern: r'596(?:0[0-8]|10|2[7-9]|3[04-9]|[4-7]\d|8[09]|9[4-9])\d{4}',
        ),
      ),
    ),
  ),
  ...
  'TO': const Country(
    ...
    phoneDescription: CountryPhoneDescription(
      ...
      validation: PhoneValidation(
        ...
        mobile: PhoneValidationRules(
          lengths: [7],
          pattern: r'(?:6(?:[09]\d|3[02]|8[15-9])|(?:7\d|8[46-9])\d|999)\d{4}',
        ),
        fixedLine: PhoneValidationRules(
          lengths: [5],
