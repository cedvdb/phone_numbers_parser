...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.GY: PhoneMetadataPatterns(
    ...
    mobile: r"(?:510|6\d\d|7(?:[01]\d|2[0-256]|3[0-2]|49))\d{4}",
    fixedLine:
  ...
  IsoCode.MX: PhoneMetadataPatterns(
    ...
    nationalPrefixTransformRule: null,
    general:
        r"1(?:(?:22|44|7[27]|87|9[69])[1-9]|65[0-689])\d{7}|(?:1(?:[01]\d|2[13-9]|[35][1-9]|4[0-35-9]|6[0-46-9]|7[013-689]|8[1-69]|9[1-578])|[2-9]\d)\d{8}",
    mobile:
  ...
  IsoCode.RO: PhoneMetadataPatterns(
    ...
    mobile:
        r"7020\d{5}|(?:6(?:[04]0|2\d)|7(?:0[013-9]|1[0-3]|[2-7]\d|8[03-8]|9[0-39]))\d{6}",
