...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.MK: PhoneMetadataPatterns(
    ...
    general: r"[2-578]\d{7}",
    mobile:
        r"7(?:3555|(?:474|9[019]7)7)\d{3}|7(?:[0-25-8]\d\d|3(?:[1-48]\d|60|7[01578])|4(?:2\d|60|7[01578])|9(?:[2-4]\d|5[01]|7[015]))\d{4}",
    fixedLine:
  ...
  IsoCode.UG: PhoneMetadataPatterns(
    ...
    mobile: r"726[01]\d{5}|7(?:[01578]\d|20|36|4[0-4]|6[0-6]|9[89])\d{6}",
    fixedLine:
